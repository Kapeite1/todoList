...
export default function App() {
  ...
  //quando abrir o app buscar no banco as tarefas e colocar no array de task
  useEffect(() => {
 ...
 return (
   <View style={styles.container}>
      ...
      {key.length > 0 && (
        ...
        <Text style={{marginLeft: 5, marginBottom: 8, color:'red'}}> Você está editando uma tarefa</Text>
      </View>
      )}
